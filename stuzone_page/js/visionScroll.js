...
*/ 
(function(a){
    a.fn.vision_scroll=function(p){
        var p=p||{};

        var g=p&&p.scroller_time_interval?p.scroller_time_interval:"3000";
        var h=p&&p.scroller_title_show?p.scroller_title_show:"enable";
        var i=p&&p.scroller_window_background_color?p.scroller_window_background_color:"#fdfefe";
        ...
        var m=p&&p.scroller_images_width?p.scroller_images_width:"190";
        var n=p&&p.scroller_images_height?p.scroller_images_height:"142";
        var o=p&&p.scroller_title_size?p.scroller_title_size:"14";
        var q=p&&p.scroller_title_color?p.scroller_title_color:"#333";
        ...
        if(h=='enable'){
            ...
            s_s_ul(dom,j,k,l,i);
        s_s_nav(dom.find(".vision-scroll-nav"),d);
        m=parseInt(m);
        ...
        begin();
        play();
        dom.find(".vision-scroll-nav").children("li").hover(
            function(){
        ...
        dom.find(".vision-scroll-nav").children("li").click(function(){
            if($(this).parent().children().index($(this))==0){
                previous()
                }else if($(this).parent().children().index($(this))==1){
                next()
    ...
    function begin(){
        ...
        dom.width(u);
        dom.height(v);
        dom.children(".vision-scroll-mask").width(u);
        dom.children(".vision-scroll-mask").height(v);
        dom.find("ul:first").children("li").show();
        dom.css("position","relative");
        dom.find("ul:first").css("position","absolute");
        dom.children(".vision-scroll-mask").width(u);
        dom.children(".vision-scroll-mask").height(v);
        dom.find(".vision-scroll-nav").css('top',(v-50)/2+parseInt(j)+"px");
        dom.find(".vision-scroll-nav").width(u)
        }
        function previous(){
        if(t==0){
            t=x-2
